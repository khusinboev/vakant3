...
export default function Layout({ children }: PropsWithChildren) {
  ...
  return (
    <div className="min-h-[var(--app-viewport-height)] bg-bg pb-[calc(4.5rem+var(--bottom-safe,0px))] md:pb-8">
      ...
      <main className="mx-auto max-w-5xl px-[calc(1rem+var(--tg-content-safe-area-left))] py-4 pr-[calc(1rem+var(--tg-content-safe-area-right))]">
        {children}
      </main>
      <BottomNav />
    </div>
