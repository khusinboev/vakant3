...
function ChartCard({ titleKey, children }: { titleKey: TranslationKey; children: ReactNode }) {
  const t = useT();
  return (
...
export default function Charts({ series }: ChartsProps) {
  ...
  return (
    <div className="grid grid-cols-1 gap-3 lg:grid-cols-2">
      <ChartCard titleKey="admin.analytics2.chart.usersTitle">
        <div
          role="img"
          aria-label={t("admin.analytics2.chart.usersAria")}
      ...
      <ChartCard titleKey="admin.analytics2.chart.revenueTitle">
        <div
          role="img"
          aria-label={t("admin.analytics2.chart.revenueAria")}
          className="h-[220px] w-full"
        >
          <ResponsiveContainer width="100%" height="100%">
      ...
      <ChartCard titleKey="admin.analytics2.chart.resumeSendsTitle">
        <div
          role="img"
      ...
      <ChartCard titleKey="admin.analytics2.chart.notifTitle">
        <div
          role="img"
          aria-label={t("admin.analytics2.chart.notifAria")}
          className="h-[220px] w-full"
        >
          <ResponsiveContainer width="100%" height="100%">
